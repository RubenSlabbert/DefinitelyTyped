...
declare namespace Generic {
    ...
    interface Legend<S extends Scale> {
        ...
        labels<T>(this: T, label: string[] | ((opts: LabelOpts) => string)): T;
    ...
    interface Continuous extends Legend<d3.ScaleContinuousNumeric<any, any>> {
        cells<T>(this: T, n: number | number[]): T;
    }
}
...
export function legendSymbol<S extends Generic.Scale>(): Generic.Legend<S> & Generic.Continuous;
